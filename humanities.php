...
<nav class="navbar navbar-expand-lg  nav-tabs nav-fill navbar-light bg-light">
    ...
    <div class="leftNav">    	
    	<div class="con">
        <a href="#"><span class="navitems" id="curent">Faculty of Computing</span></a><br />
        <a href="science.php"><span class="navitems" id="science"> Faculty of Science</span><br />
        <a href="education.php"><span class="navitems" id="education"> Faculty of Art and Social Science</span><br />
        <a href="education.php"><span class="navitems" id="education"> Faculty of Agriculture</span><br />
        <a href="education.php"><span class="navitems" id="education"> Faculty of Medicine</span><br />
        <a href="education.php"><span class="navitems" id="education"> Faculty of Management Science</span><br />
        <a href="admin.php?add"><span class="navitems" id="admin"> Back to Admin </span></a><br />
        ...
        <div class="rightcon">
          <div class="top">
           ...
           <div class="dash con">
            ...
            <center>
<h4><p>List of Registered Depatments in Faculty of Computing </h4><br /></p>
...
<?php
    ...
    $qr = "SELECT * FROM departments WHERE SchoolName = 'Faculty of Humanities'";   
    $sql = mysql_query($qr);
