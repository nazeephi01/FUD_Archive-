...
<div id="registration">
 ...
 <form id="RegisterUserForm" action="index.php" method="post">
 	<fieldset><p><label><?php echo $E; ?></label></p><br />
         <p><b>
            <label for="name">Username</label>
            <input id="name" name="user" type="text" class="text" value="" placeholder="name@example.com"/>
         </p>
 ...
 <button class="w-40 btn btn-lg btn-primary" id="save" type="submit" name="login" value="Login">Sign in</button>
</div>
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.1/jquery.min.js"></script>
